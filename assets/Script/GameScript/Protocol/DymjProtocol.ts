...
export class DymjProtocol {
    /** 客户端调用心跳 */
    static C_HEARTBEAT: number = (COCOS_MAHJONG_PROTOCOL + 0x001);
    /** 服务器主动调用心跳 */
    static S_HEARTBEAT: number = -DymjProtocol.C_HEARTBEAT;
    /** 提示消息 */
    ...
    /** 服务端用户登录返回 */
    static S_PLAYER_LOGIN: number = -DymjProtocol.C_PLAYER_LOGIN;
    ...
    /** 服务器进入游戏大厅返回 */
    static S_ENTER_HALL: number = -DymjProtocol.C_ENTER_HALL;
    /** 退出游戏大厅 EXIT_HALL */
    static C_EXIT_HALL: number = COCOS_MAHJONG_PROTOCOL + 0x006;
    /** 退出游戏大厅返回 */
    static S_EXIT_HALL: number = -DymjProtocol.C_EXIT_HALL;
    ...
    /** 进入游戏台 返回 */
    static S_ENTER_ROOM: number = -DymjProtocol.C_ENTER_ROOM;
    /** 退出游戏台 EXIT_ROOM */
    static C_EXIT_ROOM: number = COCOS_MAHJONG_PROTOCOL + 0x008;
    /** 退出游戏台返回 */
    static S_EXIT_ROOM: number = -DymjProtocol.C_EXIT_ROOM;
    /** 发起解散消息 */
    static C_SPONSOR_DISSOLVE: number = COCOS_MAHJONG_PROTOCOL + 0x009;
    /** 发起解散消息返回 */
    static S_SPONSOR_DISSOLVE: number = -DymjProtocol.C_SPONSOR_DISSOLVE;
    /** 确认解散消息 */
    static C_CONFIRM_DISSOLVE: number = COCOS_MAHJONG_PROTOCOL + 0x010;
    /** 确认解散消息返回 */
    static S_CONFIRM_DISSOLVE: number = -DymjProtocol.C_CONFIRM_DISSOLVE;
    ...
    static S_GO_ON: number = -DymjProtocol.C_GO_ON;
    ...
    /** 服务端返回重连 */
    static S_Game_Reconn_V2: number = -DymjProtocol.C_Game_Reconn_V2;
    ...
    static S_ENTRUST: number = -DymjProtocol.C_ENTRUST;

    /** 玩家查看自己的可胡牌情况 */
    static C_CHECKHU: number = COCOS_MAHJONG_PROTOCOL + 0x0202;
    static S_CHECKHU: number = -DymjProtocol.C_CHECKHU;
    ...
    static dymjMsgTypeConvert(msgType: number): number {
        if (msgType === DymjProtocol.C_PLAYER_LOGIN) {
            return DymjProtocol.S_PLAYER_LOGIN;
        } else if (msgType === DymjProtocol.C_HEARTBEAT) {
            return DymjProtocol.S_HEARTBEAT;
        } else if (msgType === DymjProtocol.C_ENTER_HALL) {
            return DymjProtocol.S_ENTER_HALL;
        } else if (msgType === DymjProtocol.C_EXIT_HALL) {
            return DymjProtocol.S_EXIT_HALL;
        } else if (msgType === DymjProtocol.C_ENTER_ROOM) {
            return DymjProtocol.S_ENTER_ROOM;
        } else if (msgType === DymjProtocol.C_EXIT_ROOM) {
            return DymjProtocol.S_EXIT_ROOM;
        } else if (msgType === DymjProtocol.C_SPONSOR_DISSOLVE) {
            return DymjProtocol.S_SPONSOR_DISSOLVE;
        } else if (msgType === DymjProtocol.C_CONFIRM_DISSOLVE) {
            return DymjProtocol.S_CONFIRM_DISSOLVE;
        } else if (msgType === DymjProtocol.C_GO_ON) {
            return DymjProtocol.S_GO_ON;
        } else if (msgType === DymjProtocol.C_Game_Reconn_V2) {
            return DymjProtocol.S_Game_Reconn_V2;
        } else if (msgType === DymjProtocol.C_ENTRUST) {
            return DymjProtocol.S_ENTRUST;
        } else if (msgType === DymjProtocol.C_CHECKHU) {
            return DymjProtocol.S_CHECKHU;
        }
